...
?>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6">
				<h4 class="text text-center text-info alert bg-primary">Cast Vote from anywhere in the world with just a few clicks</h4>
				<ul>
			...
			<div class="col-sm-6" style="margin-top: 10px;">
				<img src="vote2.jpg"  class="img img-responsive">
			</div>
		</div>
	</div>
